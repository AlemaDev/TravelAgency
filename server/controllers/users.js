...
export const signUp = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign( { email: result.email, id: result._id }, { expiresIn: "1d" } ); // aca creamos un token para esa cuenta
...
export const signIn = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ email: user.email, id: user._id }, { expiresIn: "1d" }); // aca creamos un token para esa cuenta
